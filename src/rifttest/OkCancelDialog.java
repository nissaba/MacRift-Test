 ...
 * OkCancelDialog.java
 *
 * Created on Jan 5, 2010, 8:17:38 AM
 */
...
public class OkCancelDialog extends javax.swing.JDialog {
    ...
    public OkCancelDialog(java.awt.Frame parent, String message, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(rifttest.RiftTestApp.class).getContext().getResourceMap(OkCancelDialog.class);
